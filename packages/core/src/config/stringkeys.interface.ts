...
export type StringKeysMapType = {
  ...
  'ai_training_history_table_column_credit': 'ai_training_history_table_column_credit',
  ...
  'ai_training_history_train_info_character_count': 'ai_training_history_train_info_character_count',
